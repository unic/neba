...
NEBA integrates the Spring Framework into Apache Sling. 
It makes available all of Spring's features to allow using mature, best-practice solutions for the majority of system-level concerns common to 
applications based on Apache Sling - such as Adobe AEM. 

NEBA does so in full compliance with the open core philosophy - exclusively using mature, standardized open source software - [gemini blueprint](http://www.eclipse.org/gemini/blueprint/) - for the integration into OSGi. 
